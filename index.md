...
6-måneders 30% engasjement hvor jeg deltok på et prosjekt for å kartlegge fremtiden for bruk av avansert analyse og metoder fra kunstig intelligens i Lånekassen, i sammenheng med deres interne flytting til skytjenester (Microsoft Azure). Jeg fikk her øynene opp for viktigheten av godt gjennomførte ETL-prosesser og mer generelt viktigheten av organisatorisk forankring i endringsledelse. På den tekniske siden fikk jeg dypere erfaring med blant annet Microsoft Azure, Python for maskinlæring og versjonskontroll i git.
